...
namespace HostelWebAPI.Migrations
{
    ...
    [Migration("20210609125351_add_prop_service")]
    partial class add_prop_service
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HostelWebAPI.Models.Property", b =>
                {
                    ...
                    b.Property<string>("PropertyStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50)
                        .HasDefaultValue("1");
            ...
            modelBuilder.Entity("HostelWebAPI.Models.PropertyStatus", b =>
                {
                    b.Property<string>("PropertyStatusId")
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("HostelWebAPI.Models.PropertyWithService", b =>
                {
                    ...
                    b.ToTable("PropertyWithServices");
                });
            ...
            modelBuilder.Entity("HostelWebAPI.Models.Property", b =>
                {
                    ...
                    b.HasOne("HostelWebAPI.Models.PropertyStatus", "PropertyStatus")
                        .WithMany("Properties")
